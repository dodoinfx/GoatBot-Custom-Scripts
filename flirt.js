...
setTimeout(() => {a("Thank for having fuck with me")} , 34000); //Note: Timing Must Have 1 Second Deay
setTimeout(() => {a("Babe! i will come tommorow to fuck u again.. Okeyy!! :)")} , 35000); //You Can Add More Lines
  }
};
